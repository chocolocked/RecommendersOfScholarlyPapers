...
class DataLoading:
    ...
    def initial_checking_loading_processing(self, word_pr= False ):
        ...
        self.geo_title = pickle.load(open(self.rec_conf.file_address2[2], 'rb'))
        self.geo_summary = pickle.load(open(self.rec_conf.file_address2[3], 'rb'))
        self.citation_data = pickle.load(open(self.rec_conf.file_address2[4], 'rb'))
        ...
        if word_pr:
            ...
            pickle.dump(self.geo_title, open(self.rec_conf.file_address2[2], 'wb'), protocol=4)
            ...
            pickle.dump(self.geo_summary, open(self.rec_conf.file_address2[3], 'wb'), protocol=4)
            print('Processed and save geo summeries')

        
        print('Loading all title and abstract')
        self.article_title = pickle.load(open(self.rec_conf.file_address2[0], 'rb'))
        self.article_abstract = pickle.load(open(self.rec_conf.file_address2[1], 'rb'))
        ...
        if word_pr:
            ...
            pickle.dump(self.article_title, open(self.rec_conf.file_address2[0], 'wb'), protocol=4)
            ...
            pickle.dump(self.article_abstract, open(self.rec_conf.file_address2[1], 'wb'), protocol=4)
